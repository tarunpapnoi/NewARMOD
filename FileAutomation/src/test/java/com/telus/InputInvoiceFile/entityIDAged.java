...
public class entityIDAged {

    public static void populateEntityIDAged(Map<String, String> BANValue, String BAN,int i) {
        ...
        String outputpath = output + "\\input_aged_status_YYYYMMDD" + i + ".xlsx";
                ...
                while (rowIterator.hasNext()) {
                    ...
                    if (entityCell != null && entityValue.equals(String.valueOf(entityCell.getNumericCellValue()))) {
                        ...
                        if (banCell != null && banCell.getNumericCellValue() != Integer.parseInt(BAN)) {
                            ...
                            row1.createCell(0).setCellValue(banCell.getNumericCellValue());
                            for (int j=1;j<57;j++) {           //set all cells to 0
                                row1.createCell(j).setCellValue(0);
                            }
                            row1.createCell(57).setCellValue("NEW");
                        }
                        found = true;
                    }
                }
